...
def multi_omic_stabl_cv_josh(
    ...
    table_of_scores = compute_scores_table( # This function only creates summary statistics of the predictions without directly delivering predictions
        predictions_dict=predictions_dict,
        y=y,
        task_type=task_type,
        selected_features_dict=formatted_features_dict
